...
public class ColorPickerSeekView extends View {
    ...
    public ColorPickerSeekView(Context context) {
        super(context);
    }

    public ColorPickerSeekView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorPickerSeekView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnColorPickerChangeListener {
         ...
         * @param color  颜色
         */
        void onColorChanged(ColorPickerSeekView picker, int color);
         ...
         * @param picker ColorPickerView
         */
        void onStartTrackingTouch(ColorPickerSeekView picker);
         ...
         * @param picker ColorPickerView
         */
        void onStopTrackingTouch(ColorPickerSeekView picker);
    }
