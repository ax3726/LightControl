...
public abstract class BaseActivity<P extends BasePresenter, B extends ViewDataBinding> extends RxAppCompatActivity implements BaseView, BaseHttpListener, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        switch (AppUtils.getInstance().getAppStatus()) {
            case AppUtils.STATUS_FORCE_KILLED://APP被杀死
                Log.e("eeeeee", "App被杀死了");
                ThisApplication.getInstance().restartApp(this);
                break;
            case AppUtils.STATUS_NORMAL:
                break;
            default:
                break;
        }
    ...
    public void showToast(final int id) {
        if (aty != null) {
            ToastUtils.showToast(aty, getResources().getString(id));
    ...
    public void restartLogin() {
        ...
        String broadcastIntent = "com.lm.RESTART_LOGIN";
